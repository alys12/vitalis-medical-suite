...
import type { User, Chat, ChatMessage, Patient, Appointment } from "@shared/types";
import { 
  MOCK_CHAT_MESSAGES, MOCK_CHATS, MOCK_USERS,
...
export class PatientEntity extends IndexedEntity<Patient> {
  ...
  static readonly initialState: Patient = {
    ...
    vitals: { bloodPressure: "", heartRate: 0, temperature: 0, weight: 0, height: 0, oxygenSaturation: 0 },
    history: [],
    notes: []
  };
