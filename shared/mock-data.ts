import { subDays, format, addDays, startOfWeek, setHours, setMinutes } from 'date-fns';
import type { 
  User, Chat, ChatMessage, 
  Patient, DashboardStat, ActivityItem, ChartDataPoint, Appointment,
  RevenueData, DemographicData, AppointmentTrend
} from './types';
// --- Existing Template Mock Data ---
...
export const MOCK_APPOINTMENTS: Appointment[] = [
  {
    ...
    start: setMinutes(setHours(addDays(startOfCurrentWeek, 0), 9), 0).toISOString(), // Mon 9:00
    end: setMinutes(setHours(addDays(startOfCurrentWeek, 0), 10), 0).toISOString(),
    type: 'Follow-up',
    status: 'Confirmed'
  },
  {
    ...
    start: setMinutes(setHours(addDays(startOfCurrentWeek, 0), 11), 30).toISOString(), // Mon 11:30
    end: setMinutes(setHours(addDays(startOfCurrentWeek, 0), 12), 30).toISOString(),
    type: 'Consultation',
    status: 'Scheduled'
  },
  {
    ...
    start: setMinutes(setHours(addDays(startOfCurrentWeek, 1), 14), 0).toISOString(), // Tue 14:00
    end: setMinutes(setHours(addDays(startOfCurrentWeek, 1), 14), 45).toISOString(),
    type: 'Checkup',
    status: 'Confirmed'
  },
  {
    ...
    start: setMinutes(setHours(addDays(startOfCurrentWeek, 2), 10), 0).toISOString(), // Wed 10:00
    end: setMinutes(setHours(addDays(startOfCurrentWeek, 2), 11), 0).toISOString(),
    type: 'Follow-up',
    status: 'Confirmed'
  },
  {
    ...
    start: setMinutes(setHours(addDays(startOfCurrentWeek, 3), 15), 30).toISOString(), // Thu 15:30
    end: setMinutes(setHours(addDays(startOfCurrentWeek, 3), 16), 30).toISOString(),
    type: 'Consultation',
    status: 'Scheduled'
  },
  {
    ...
    start: setMinutes(setHours(addDays(startOfCurrentWeek, 4), 9), 0).toISOString(), // Fri 9:00
    end: setMinutes(setHours(addDays(startOfCurrentWeek, 4), 10), 30).toISOString(),
    type: 'Checkup',
    status: 'Confirmed'
  },
  {
    ...
    start: setMinutes(setHours(addDays(startOfCurrentWeek, 4), 13), 0).toISOString(), // Fri 13:00
    end: setMinutes(setHours(addDays(startOfCurrentWeek, 4), 13), 30).toISOString(),
    type: 'Follow-up',
    status: 'Scheduled'
  }
];
export const MOCK_REVENUE_BY_SERVICE: RevenueData[] = [
...
export const MOCK_APPOINTMENT_TRENDS: AppointmentTrend[] = [
